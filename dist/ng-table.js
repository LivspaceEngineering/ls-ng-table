...
angular.module('ngTable').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('ng-table/filters/date-range.html', '<div class="clearfix"> <div class="pull-left" style="width:50%"> <div class="datepicker-wrapper" ng-click="openCalendar(getKey(\'from\',name))"> <input type="text" class="form-control" uib-datepicker-popup="{{format}}" is-open="popup[getKey(\'from\',name)].opened" datepicker-options="dateOptions" ng-required="true" close-text="Close" alt-input-formats="altInputFormats" show-weeks="false" show-button-bar="false" close-on-date-selection="true" ng-disabled="$filterRow.disabled" ng-model="params.filter()[name][\'from_date\']" placeholder="From"/> <span class="fa fa-calendar"></span> </div> </div> <div class="pull-left" style="width:50%"> <div class="datepicker-wrapper" ng-click="openCalendar(getKey(\'to\',name))"> <input type="text" class="form-control" uib-datepicker-popup="{{format}}" is-open="popup[getKey(\'to\',name)].opened" datepicker-options="dateOptions" ng-required="true" close-text="Close" alt-input-formats="altInputFormats" show-weeks="false" show-button-bar="false" close-on-date-selection="true" ng-disabled="$filterRow.disabled" ng-model="params.filter()[name][\'to_date\']" placeholder="To"/> <span class="fa fa-calendar"></span> </div> </div> </div> ');
	...
	$templateCache.put('ng-table/filters/select-multiple.html', '<ui-select multiple ng-model="params.filter()[name]" class=" custom-match-items" theme="bootstrap" close-on-select="false" remove-selected="false" ng-disabled="$filterRow.disabled"> <ui-select-match placeholder=""> <p class="ls-match-choice">{{$item.title}}</p> </ui-select-match> <ui-select-choices repeat="data in $column.data | filter:$select.search"> <span class="filter-value" ng-bind-html="data.title | highlight: $select.search"></span> </ui-select-choices> </ui-select> ');
	$templateCache.put('ng-table/filters/select.html', '<ui-select ng-model="params.filter()[name]" class="full-width" theme="bootstrap" search-enabled="true" ng-disabled="$filterRow.disabled"> <ui-select-match placeholder="" allow-clear="true"> {{$select.selected.title}} </ui-select-match> <ui-select-choices repeat="data in $column.data | filter:$select.search"> <span class="filter-value" ng-bind-html="data.title | highlight: $select.search"></span> </ui-select-choices> </ui-select> ');
